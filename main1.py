...
def ajustar_estetica_modelo1(caminho_origem_xlsx, caminho_saida_xlsx):
...
if __name__ == "__main__":
    ...
    arquivo_saida_formatado = "Planilha_Sintetica_Convertida_Modelo1.xlsx"
    
    ajustar_estetica_modelo1(arquivo_origem_sistema, arquivo_saida_formatado)