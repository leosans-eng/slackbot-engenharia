...
def gerar_caminho_saida_modelo2(caminho_origem, nome_obra):
    diretorio = os.path.dirname(os.path.abspath(caminho_origem)) or "."
    if nome_obra:
        nome_limpo = sanitizar_nome_arquivo(nome_obra)
        nome_arquivo = f"Planilha_Sintetica_Convertida_Modelo2 - {nome_limpo}.xlsx"
    else:
        nome_arquivo = "Planilha_Sintetica_Convertida_Modelo2.xlsx"
...
def ajustar_estetica_modelo2(caminho_origem_xlsx):
    ...
    caminho_saida_xlsx = gerar_caminho_saida_modelo2(caminho_origem_xlsx, nome_obra)
...
if __name__ == "__main__":
    ...
    ajustar_estetica_modelo2(arquivo_origem_sistema)
